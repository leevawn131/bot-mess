...
module.exports = {
    ...
    execute: async ({ api, event, args, config }) => {
        ...
        // Kiểm tra xem nhóm có đang thuê gói admin không và thông tin người thuê bot
        const { checkIsAdminRental, getRenterID } = require('../../utils/rental');
        ...
        if (!newMode) {
            ...
            return api.sendMessage(
                `🎛️ MODE HIỆN TẠI\n━━━━━━━━━━━━━\n${modeEmoji[currentMode]} Mode: ${currentMode.toUpperCase()}\n📝 ${modeDesc[currentMode]}${timerLine}${inLine}\n━━━━━━━━━━━━━\n💡 ${prefix}mode user/qtv - Đổi mode ngay\n💡 ${prefix}mode qtv 23:00 - Lịch hằng ngày\n💡 ${prefix}mode in 00:30 user/qtv - Đổi sang mode user/qtv trong 30 phút xong quay về mode cũ.\n💡 ${prefix}mode off hoặc ${prefix}mode off qtv hoặc ${prefix}mode off in - Tắt toàn bộ lịch`,
                threadID,
                messageID
            );
        }
